...
const addfavoriteCities = async(req,res) => {
    ...
    try {
           ...
           if( alreadyAdded ){
            return res.send("City is already present in user's favorite list").status(200);
           }
           ...
           let url = `https://api.openweathermap.org/data/2.5/find?q=${cityName}&appid=5796abbde9106b7da4febfae8c44c232&units=metric`
...
module.exports = addfavoriteCities;