    ...
    <Container className="mt-4">
      ...
      <div className="content__weather">
        <Row className="d-flex justify-content-center">
          ...
          <Col>
            <p>City: <span className="fw-bold">{data?.name}</span> - Country: <span className="fw-bold">{data?.sys?.country}</span></p>
            <p>
              <i className="bi bi-thermometer-half"></i>{" "}
              Temp. <span className="fw-bold">{data?.main?.temp} °C</span> - 
              <i className="bi bi-thermometer-low"></i>{" "}Temp. Min <span className="fw-bold">{data?.main?.temp_min} °C</span> - 
              <i className="bi bi-thermometer-high"></i>{" "}Temp. Max <span className="fw-bold">{data?.main?.temp_max} °C</span>
            </p>
